...
class DText
  class Ruby
    ...
    def self.parse_id_links(str)
      ...
      str = str.gsub(/\bforum #(\d+)/i, %{<a href="/forums/posts/\\1">forum #\\1</a>})
      str = str.gsub(/\btopic #(\d+)(?!\/p\d|\d)/i, %{<a href="/forums/topics/\\1">topic #\\1</a>})
      str = str.gsub(/\btopic #(\d+)\/p(\d+)/i, %{<a href="/forums/topics/\\1?page=\\2">topic #\\1/p\\2</a>})
      str = str.gsub(/\bcategory #(\d+)/i, %{<a href="/forums/categories/\\1">category #\\1</a>})
