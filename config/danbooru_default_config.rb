...
module Danbooru
  class Configuration
    ...
    def memcached_servers
      Rails.env.production? ? [ "172.31.0.3:11211" ] : [ "127.0.0.1:11211" ]
    ...
    def storage_manager
      ...
      if Rails.env.production?
        #StorageManager::S3.new("yiffy3", base_url: "https://v3.yiff.media", hierarchical: true)
        StorageManager::Local.new(base_url: "https://v3.yiff.media/", hierarchical: true)
      else
...
#END TAG
    ...
    def elasticsearch_host
      Rails.env.production? ? "172.31.0.2" : "127.0.0.0"
    end
