...
FactoryBot.define do
  factory(:post_replacement_media_asset) do
    ...
    factory(:jpg_post_replacement_media_asset) do
    ...
    factory(:png_post_replacement_media_asset) do
    ...
    factory(:apng_post_replacement_media_asset) do
    ...
    factory(:webp_post_replacement_media_asset) do
    ...
    factory(:gif_post_replacement_media_asset) do
    ...
    factory(:mp4_post_replacement_media_asset) do
    ...
    factory(:webm_post_replacement_media_asset) do
    ...
    factory(:jpg_invalid_post_replacement_media_asset) do
      checksum { "7df25d6181c015d4cf3e003d5d84a0d9" }
      file { fixture_file_upload("test-corrupt.jpg") }
    end

    factory(:empty_post_replacement_media_asset) do
