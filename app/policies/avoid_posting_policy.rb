...
class AvoidPostingPolicy < ApplicationPolicy
  ...
  def permitted_search_params
    params = super + %i[creator_name creator_id any_name_matches artist_id artist_name any_other_name_matches details is_active] + nested_search_params(creator: User, updater: User, artist: Artist)
