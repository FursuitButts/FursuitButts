...
def handle(post_replacement)
  ...
  asset = PostReplacementMediaAsset.new(file: File.open(file_path(post_replacement.md5_in_database, post_replacement.file_ext_in_database)), creator_id: post_replacement.creator_id, creator_ip_addr: post_replacement.creator_ip_addr)
  asset.save!
