...
if User.count == 0
  ...
  Timecop.travel(1.month.ago) do
    ...
    newuser.promote_to!(User::Levels::PRIVILEGED, {:can_upload_free => true, :is_upgrade => true, :skip_dmail => true})
    ...
    newuser.promote_to!(User::Levels::PRIVILEGED, {:can_approve_posts => true, :is_upgrade => true, :skip_dmail => true})
